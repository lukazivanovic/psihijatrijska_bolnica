            ...
            let vueForm1=new Vue(
                {
                    ...
                    data:
                    {
                        ...
                        dijagnoza:null,
                        terapija:null,
                        pacijent_id:sessionStorage.getItem('pacijent_id'),
                        lekar_id:sessionStorage.getItem('lekar_id'),
                        tip_pos: 1,
                        errors:[],
                        odgovor:"",
                        check_codes:false,
                    ...
                    methods:{
                        ...
                        submit()
                        {
                            this.pacijent_id=sessionStorage.getItem('pacijent_id');
                            this.lekar_id=sessionStorage.getItem('lekar_id');
